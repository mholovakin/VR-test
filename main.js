...
const requestDeviceOrientation = async () => {
  ...
  try {
    ...
    if (permission === 'granted') {
      ...
      latestHandler = e => {
        latestEvent.alpha = Math.atan2(e.acceleration.x, -e.acceleration.z);
        latestEvent.beta = Math.atan2(e.acceleration.y, (e.acceleration.x ** 2 + e.acceleration.z ** 2));
        latestEvent.gamma = Math.atan2(-e.acceleration.x, -e.acceleration.y);
        latestEvent.event = e;
      };
